...
from models.hebbian_mamba import Config
...
if __name__ == "__main__":
    ...
    ax.set_xticklabels(pairs_list, rotation=90)
    ...
    fig.tight_layout()
    fig.savefig("eval_synthetic_recall/capacity.png", dpi=150)
    print(f"\nsaved eval_synthetic_recall/capacity.png")
